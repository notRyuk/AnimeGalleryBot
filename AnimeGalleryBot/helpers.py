start_text = '''This bot is for downloading any anime directly via links in multiple quality.
...
(HDP-mp4) links can be directly opened in **VLC or MX player** to stream episodes without downloading
